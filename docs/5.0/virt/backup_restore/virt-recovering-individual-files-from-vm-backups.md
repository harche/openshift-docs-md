...
- [Use virtual machine file restore](../../virt/backup_restore/virt-using-vm-file-restore.xml#virt-using-vm-file-restore)

- [Backing up and restoring virtual machines](../../virt/backup_restore/virt-backup-restore-overview.xml#virt-backup-restore-overview)

- [Backup and restore by using VM snapshots](../../virt/backup_restore/virt-backup-restore-snapshots.xml#virt-backup-restore-snapshots)

- [Introduction to OpenShift API for Data Protection](../../backup_and_restore/application_backup_and_restore/oadp-intro.xml#oadp-introduction)
