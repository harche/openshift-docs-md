...
| `ovsDpdk`         | `string`  | OvsDpdk defines a set of CPUs reserved for OVS-DPDK PMD (Poll Mode Driver) threads, fully isolated from the operating system and Kubernetes scheduling. WorkloadPartitioning or --strict-cpu-reservation kubelet CPUManager policy option are a prerequisite for this feature.                                                                                                                                                                                                                                                                             |
