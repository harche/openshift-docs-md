...
| HTTP code          | Reponse body                                                                                                                               |
|--------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| 200 - OK           | [`ValidatingWebhookConfigurationList`](../objects/index.xml#io-k8s-api-admissionregistration-v1-ValidatingWebhookConfigurationList) schema |
| 401 - Unauthorized | Empty                                                                                                                                      |
...
| Parameter | Type                                                                                                                                                                                           | Description |
|-----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| `body`    | [`ValidatingWebhookConfiguration`](../extension_apis/validatingwebhookconfiguration-admissionregistration-k8s-io-v1.xml#validatingwebhookconfiguration-admissionregistration-k8s-io-v1) schema |             |

Body parameters

| HTTP code          | Reponse body                                                                                                                                                                                   |
|--------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 200 - OK           | [`ValidatingWebhookConfiguration`](../extension_apis/validatingwebhookconfiguration-admissionregistration-k8s-io-v1.xml#validatingwebhookconfiguration-admissionregistration-k8s-io-v1) schema |
| 201 - Created      | [`ValidatingWebhookConfiguration`](../extension_apis/validatingwebhookconfiguration-admissionregistration-k8s-io-v1.xml#validatingwebhookconfiguration-admissionregistration-k8s-io-v1) schema |
| 202 - Accepted     | [`ValidatingWebhookConfiguration`](../extension_apis/validatingwebhookconfiguration-admissionregistration-k8s-io-v1.xml#validatingwebhookconfiguration-admissionregistration-k8s-io-v1) schema |
| 401 - Unauthorized | Empty                                                                                                                                                                                          |
