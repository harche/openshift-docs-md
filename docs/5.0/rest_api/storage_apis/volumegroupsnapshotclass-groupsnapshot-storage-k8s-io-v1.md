...
| `parameters`     | `object (string)`                                                                    | Parameters is a key-value map with storage driver specific parameters for creating group snapshots. These values are opaque to Kubernetes and are passed directly to the driver.                                                                                                                                                                                                                                                                                                          |

# API endpoints

The following API endpoints are available:

- `/apis/groupsnapshot.storage.k8s.io/v1/volumegroupsnapshotclasses`
...
- `/apis/groupsnapshot.storage.k8s.io/v1/volumegroupsnapshotclasses/{name}`
...
| HTTP code          | Reponse body                                                                                                               |
|--------------------|----------------------------------------------------------------------------------------------------------------------------|
| 200 - OK           | [`VolumeGroupSnapshotClassList`](../objects/index.xml#io-k8s-storage-groupsnapshot-v1-VolumeGroupSnapshotClassList) schema |
| 401 - Unauthorized | Empty                                                                                                                      |
...
| Parameter | Type                                                                                                                                                                       | Description |
|-----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| `body`    | [`VolumeGroupSnapshotClass`](../storage_apis/volumegroupsnapshotclass-groupsnapshot-storage-k8s-io-v1.xml#volumegroupsnapshotclass-groupsnapshot-storage-k8s-io-v1) schema |             |

Body parameters

| HTTP code          | Reponse body                                                                                                                                                               |
|--------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 200 - OK           | [`VolumeGroupSnapshotClass`](../storage_apis/volumegroupsnapshotclass-groupsnapshot-storage-k8s-io-v1.xml#volumegroupsnapshotclass-groupsnapshot-storage-k8s-io-v1) schema |
| 201 - Created      | [`VolumeGroupSnapshotClass`](../storage_apis/volumegroupsnapshotclass-groupsnapshot-storage-k8s-io-v1.xml#volumegroupsnapshotclass-groupsnapshot-storage-k8s-io-v1) schema |
| 202 - Accepted     | [`VolumeGroupSnapshotClass`](../storage_apis/volumegroupsnapshotclass-groupsnapshot-storage-k8s-io-v1.xml#volumegroupsnapshotclass-groupsnapshot-storage-k8s-io-v1) schema |
| 401 - Unauthorized | Empty                                                                                                                                                                      |
...
| Parameter | Type     | Description                          |
|-----------|----------|--------------------------------------|
| `name`    | `string` | name of the VolumeGroupSnapshotClass |
