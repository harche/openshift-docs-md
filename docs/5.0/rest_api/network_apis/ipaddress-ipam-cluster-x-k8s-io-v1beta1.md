...
| Parameter | Type                                                                                                                      | Description |
|-----------|---------------------------------------------------------------------------------------------------------------------------|-------------|
| `body`    | [`IPAddress`](../network_apis/ipaddress-ipam-cluster-x-k8s-io-v1beta1.xml#ipaddress-ipam-cluster-x-k8s-io-v1beta1) schema |             |

Body parameters

| HTTP code          | Reponse body                                                                                                              |
|--------------------|---------------------------------------------------------------------------------------------------------------------------|
| 200 - OK           | [`IPAddress`](../network_apis/ipaddress-ipam-cluster-x-k8s-io-v1beta1.xml#ipaddress-ipam-cluster-x-k8s-io-v1beta1) schema |
| 201 - Created      | [`IPAddress`](../network_apis/ipaddress-ipam-cluster-x-k8s-io-v1beta1.xml#ipaddress-ipam-cluster-x-k8s-io-v1beta1) schema |
| 202 - Accepted     | [`IPAddress`](../network_apis/ipaddress-ipam-cluster-x-k8s-io-v1beta1.xml#ipaddress-ipam-cluster-x-k8s-io-v1beta1) schema |
| 401 - Unauthorized | Empty                                                                                                                     |
