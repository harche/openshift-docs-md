...
11. Verify the creation process using available `BareMetalHost` objects by completing the following steps:
...
- [etcd backup](../../backup_and_restore/control_plane_backup_and_restore/backing-up-etcd.xml#backing-up-etcd-data_backup-etcd)
