...
- [Creating a re-encrypt route with a custom certificate](../../networking/ingress_load_balancing/routes/securing-routes.xml#nw-ingress-creating-a-reencrypt-route-with-a-custom-certificate_secured-routes)
