...
- [Externally managed certificates](../../networking/ingress_load_balancing/routes/securing-routes.xml#nw-ingress-route-secret-load-external-cert_secured-routes)
