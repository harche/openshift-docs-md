...
- [About OpenShift Container Platform monitoring](../observability/monitoring/about-ocp-monitoring.xml#about-ocp-monitoring)

- [Creating applications by using the Developer perspective](../applications/creating_applications/odc-creating-applications-using-developer-perspective.xml#odc-creating-applications-using-developer-perspective)

- [Accessing the web console](../web_console/web-console.xml#web-console)

- [About the Developer perspective](../web_console/web-console-overview.xml#about-developer-perspective_web-console-overview)
