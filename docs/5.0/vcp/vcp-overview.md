...
- [Prerequisites for virtualized control planes](vcp-prerequisites.xml#vcp-prerequisites)

- [Installing KubeVirt Redfish](../virt/post_installation_configuration/virt-kubevirt-redfish.xml#proc_virt-installing-kubevirt-redfish_virt-kubevirt-redfish)
