...
2.  Create a `VirtualMachine` CR for each control plane node by creating a YAML file with content such as the following example:
...
3.  Apply the resource by running the following command:
