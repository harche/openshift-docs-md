...
- [Tutorial: Deploying an application by using the CLI](../tutorials/dev-app-cli.xml#dev-app-cli)

- [Tutorial: Deploying an application by using the web console](../tutorials/dev-app-web-console.xml#dev-app-web-console)
