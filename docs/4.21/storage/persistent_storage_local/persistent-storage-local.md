...
- [Installing the Local Storage Operator](../../storage/persistent_storage_local/persistent-storage-local.xml#local-storage-install-overview_persistent-storage-local)

- [Enabling Local Storage Operator Metrics](../../storage/persistent_storage_local/persistent-storage-local.xml#local-storage-metrics-procedure_persistent-storage-local)
