...
- [Adding a catalog to a cluster](../../extensions/catalogs/managing-catalogs.xml#olmv1-adding-a-catalog-to-a-cluster_managing-catalogs)

- [Red Hat-provided catalogs](../../extensions/catalogs/rh-catalogs.xml#rh-catalogs)
