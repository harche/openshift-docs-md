...
To uninstall MTC, see [Uninstalling MTC and deleting resources](../migrating_from_ocp_3_to_4/installing-3-4.xml#migration-uninstalling-mtc-clean-up_installing-3-4).
...
MTC supports the [file system and snapshot data copy methods](../migrating_from_ocp_3_to_4/about-mtc-3-4.xml#migration-understanding-data-copy-methods_about-mtc-3-4) for migrating data from the source cluster to the target cluster. You can select a method that is suited for your environment and is supported by your storage provider.

The following storage providers are supported:

- [Multicloud Object Gateway](../migrating_from_ocp_3_to_4/installing-3-4.xml#migration-configuring-mcg_installing-3-4)

- [Amazon Web Services S3](../migrating_from_ocp_3_to_4/installing-3-4.xml#migration-configuring-aws-s3_installing-3-4)

- [Google Cloud](../migrating_from_ocp_3_to_4/installing-3-4.xml#migration-configuring-gcp_installing-3-4)

- [Microsoft Azure Blob](../migrating_from_ocp_3_to_4/installing-3-4.xml#migration-configuring-azure_installing-3-4)
...
- [MTC workflow](../migrating_from_ocp_3_to_4/about-mtc-3-4.xml#migration-mtc-workflow_about-mtc-3-4)

- [About data copy methods](../migrating_from_ocp_3_to_4/about-mtc-3-4.xml#migration-understanding-data-copy-methods_about-mtc-3-4)

- [Adding a replication repository to the MTC web console](../migrating_from_ocp_3_to_4/migrating-applications-3-4.xml#migration-adding-replication-repository-to-cam_migrating-applications-3-4)
