...
- [Ensuring that CNF workloads run uninterrupted with pod disruption budgets](../../../edge_computing/day_2_core_cnf_clusters/updating/update-cnf-update-prep.xml#update-pdb_update-cnf-update-prep)
