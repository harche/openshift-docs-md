...
- [Configuring a local arbiter node](../installing_bare_metal/ipi/ipi-install-installation-workflow.xml#ipi-install-config-local-arbiter-node_ipi-install-installation-workflow)
