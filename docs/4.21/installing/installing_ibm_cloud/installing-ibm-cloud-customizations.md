In OpenShift Container Platform version 4.17, you can install a customized cluster on IBM Cloud® by using installer-provisioned infrastructure. Change parameters in the `install-config.yaml` file before you install the cluster.
