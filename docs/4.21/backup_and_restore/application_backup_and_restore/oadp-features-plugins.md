...
- OADP 1.5.8 was tested successfully against OpenShift Container Platform 4.19 for both IBM Power® and IBM Z®. The sections that follow give testing and support information for OADP 1.5.8 in terms of backup locations for these systems.
...
- IBM Power® running with OpenShift Container Platform 4.19 and OADP 1.5.8 was tested successfully against an AWS S3 backup location target. Although the test involved only an AWS S3 target, Red Hat supports running IBM Power® with OpenShift Container Platform 4.19 and OADP 1.5.8 against all S3 backup location targets, which are not AWS, as well.
...
- IBM Z® running with OpenShift Container Platform 4.19 and OADP 1.5.8 was tested successfully against an AWS S3 backup location target. Although the test involved only an AWS S3 target, Red Hat supports running IBM Z® with OpenShift Container Platform 4.19 and OADP 1.5.8 against all S3 backup location targets, which are not AWS, as well.
