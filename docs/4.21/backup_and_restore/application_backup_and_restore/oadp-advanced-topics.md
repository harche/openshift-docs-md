...
- Advanced mitigations:
  ...
  - Fix UID ranges after migration by [Resolving overlapping UID ranges in OpenShift namespaces after migration](https://access.redhat.com/articles/6844071). Step 1 is optional.
...
- [Working with different Kubernetes API versions on the same cluster](../../backup_and_restore/application_backup_and_restore/oadp-advanced-topics.xml#oadp-different-kubernetes-api-versions).
