...
| Property | Type | Description |
|----|----|----|
| `clientType` | `string` | clientType defines the client used to export the traces. Supported values are `http` or `grpc`. |
...
|----|----|
| 200 - OK | [`PrometheusList`](../objects/index.xml#com-coreos-monitoring-v1-PrometheusList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Prometheus`](../monitoring_apis/prometheus-monitoring-coreos-com-v1.xml#prometheus-monitoring-coreos-com-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Prometheus`](../monitoring_apis/prometheus-monitoring-coreos-com-v1.xml#prometheus-monitoring-coreos-com-v1) schema |
| 201 - Created | [`Prometheus`](../monitoring_apis/prometheus-monitoring-coreos-com-v1.xml#prometheus-monitoring-coreos-com-v1) schema |
| 202 - Accepted | [`Prometheus`](../monitoring_apis/prometheus-monitoring-coreos-com-v1.xml#prometheus-monitoring-coreos-com-v1) schema |
| 401 - Unauthorized | Empty |
