...
| HTTP code          | Reponse body                                                                                                                           |
|--------------------|----------------------------------------------------------------------------------------------------------------------------------------|
| 200 - OK           | [`MutatingWebhookConfigurationList`](../objects/index.xml#io-k8s-api-admissionregistration-v1-MutatingWebhookConfigurationList) schema |
| 401 - Unauthorized | Empty                                                                                                                                  |
...
| Parameter | Type                                                                                                                                                                                     | Description |
|-----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| `body`    | [`MutatingWebhookConfiguration`](../extension_apis/mutatingwebhookconfiguration-admissionregistration-k8s-io-v1.xml#mutatingwebhookconfiguration-admissionregistration-k8s-io-v1) schema |             |

Body parameters

| HTTP code          | Reponse body                                                                                                                                                                             |
|--------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 200 - OK           | [`MutatingWebhookConfiguration`](../extension_apis/mutatingwebhookconfiguration-admissionregistration-k8s-io-v1.xml#mutatingwebhookconfiguration-admissionregistration-k8s-io-v1) schema |
| 201 - Created      | [`MutatingWebhookConfiguration`](../extension_apis/mutatingwebhookconfiguration-admissionregistration-k8s-io-v1.xml#mutatingwebhookconfiguration-admissionregistration-k8s-io-v1) schema |
| 202 - Accepted     | [`MutatingWebhookConfiguration`](../extension_apis/mutatingwebhookconfiguration-admissionregistration-k8s-io-v1.xml#mutatingwebhookconfiguration-admissionregistration-k8s-io-v1) schema |
| 401 - Unauthorized | Empty                                                                                                                                                                                    |
