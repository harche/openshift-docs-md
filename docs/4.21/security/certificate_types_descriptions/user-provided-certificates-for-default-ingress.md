...
- [Setting a custom default certificate](../../networking/networking_operators/ingress-operator.xml#nw-ingress-setting-a-custom-default-certificate_configuring-ingress)
