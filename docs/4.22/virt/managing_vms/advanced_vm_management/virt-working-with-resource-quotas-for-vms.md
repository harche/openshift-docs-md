...
- [Resource quotas across many projects](../../../applications/quotas/quotas-setting-across-multiple-projects.xml#quotas-setting-across-multiple-projects)

- [Understanding the Application Aware Quota operator](../../../virt/managing_vms/advanced_vm_management/virt-working-with-resource-quotas-for-vms.xml#virt-understanding-aaq-operator_virt-working-with-resource-quotas-for-vms)

- [Enabling the Application Aware Quota operator](../../../virt/managing_vms/advanced_vm_management/virt-working-with-resource-quotas-for-vms.xml#virt-enabling-aaq-operator_virt-working-with-resource-quotas-for-vms)

- [Creating virtual machine quotas using the web console](../../../virt/managing_vms/advanced_vm_management/virt-working-with-resource-quotas-for-vms.xml#virt-creating-vm-quotas-web_virt-working-with-resource-quotas-for-vms)

- [Managing virtual machine quotas using the list view](../../../virt/managing_vms/advanced_vm_management/virt-working-with-resource-quotas-for-vms.xml#virt-managing-quotas-list-web_virt-working-with-resource-quotas-for-vms)

- [Managing virtual machine quota details using the web console](../../../virt/managing_vms/advanced_vm_management/virt-working-with-resource-quotas-for-vms.xml#virt-managing-quota-details-web_virt-working-with-resource-quotas-for-vms)
