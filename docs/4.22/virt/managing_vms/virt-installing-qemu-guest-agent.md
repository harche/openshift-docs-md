...
<table>
<caption>Supported drivers</caption>
<colgroup>
<col style="width: 33%" />
<col style="width: 33%" />
<col style="width: 33%" />
...
<td style="text-align: left;"><p>The network driver. Sometimes labeled as an <strong>Ethernet Controller</strong> in the <strong>Other devices</strong> group. Available only if a VirtIO NIC is configured.</p></td>
</tr>
</tbody>
</table>
