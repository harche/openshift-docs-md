...
MTC supports the [file system and snapshot data copy methods](../migration_toolkit_for_containers/about-mtc.xml#migration-understanding-data-copy-methods_about-mtc) for migrating data from the source cluster to the target cluster. You can select a method that is suited for your environment and is supported by your storage provider.
