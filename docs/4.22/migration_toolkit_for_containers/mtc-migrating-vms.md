...
Before migrating virtual machine storage, you must install [OpenShift Virtualization Operator](../virt/install/installing-virt.xml#installing-virt-operator_installing-virt).
...
You also need to configure `KubeVirt` to enable storage live migration according to the [Configuring live migration](../virt/live_migration/virt-configuring-live-migration.xml#virt-configuring-live-migration-limits_virt-configuring-live-migration).
