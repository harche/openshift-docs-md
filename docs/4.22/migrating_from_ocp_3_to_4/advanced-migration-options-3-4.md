...
- For information about creating a MigCluster CR manifest for each remote cluster, see [Migrating an application by using the MTC API](../migrating_from_ocp_3_to_4/advanced-migration-options-3-4.xml#migration-migrating-applications-api_advanced-migration-options-3-4).

- For information about adding a cluster using the web console, see [Migrating your applications by using the MTC web console](../migrating_from_ocp_3_to_4/migrating-applications-3-4.xml#migrating-applications-mtc-web-console_migrating-applications-3-4)
...
- See [Excluding PVCs from migration](../migrating_from_ocp_3_to_4/advanced-migration-options-3-4.xml#migration-excluding-pvcs_advanced-migration-options-3-4) to select PVCs for state migration.

- See [Mapping PVCs](../migrating_from_ocp_3_to_4/advanced-migration-options-3-4.xml#migration-mapping-pvcs_advanced-migration-options-3-4) to migrate source PV data to provisioned PVCs on the destination cluster.

- See [Migrating Kubernetes objects](../migrating_from_ocp_3_to_4/advanced-migration-options-3-4.xml#migration-kubernetes-objects_advanced-migration-options-3-4) to migrate the Kubernetes objects that constitute an application’s state.
...
- For details about the `move` and `copy` actions, see [MTC workflow](../migrating_from_ocp_3_to_4/about-mtc-3-4.xml#migration-mtc-workflow_about-mtc-3-4).

- For details about the `skip` action, see [Excluding PVCs from migration](../migrating_from_ocp_3_to_4/advanced-migration-options-3-4.xml#migration-excluding-pvcs_advanced-migration-options-3-4).

- For details about the file system and snapshot copy methods, see [About data copy methods](../migrating_from_ocp_3_to_4/about-mtc-3-4.xml#migration-understanding-data-copy-methods_about-mtc-3-4).
