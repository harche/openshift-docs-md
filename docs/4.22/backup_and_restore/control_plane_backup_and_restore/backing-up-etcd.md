...
- [Recovering an unhealthy etcd cluster for hosted control planes](../../hosted_control_planes/hcp_high_availability/hcp-recovering-etcd-cluster.xml#hcp-recovering-etcd-cluster)
