...
The Distributed Tracing Platform 3.8.2 patch release includes a fix for the following issue:
...
[CVE-2025-58183](https://www.cve.org/CVERecord?id=CVE-2025-58183)
...
[TRACING-5622](https://issues.redhat.com/browse/TRACING-5622)
