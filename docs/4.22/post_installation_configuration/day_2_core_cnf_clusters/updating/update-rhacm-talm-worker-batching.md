...
- [Configuring application pods before updating your OpenShift Container Platform cluster](../../../post_installation_configuration/day_2_core_cnf_clusters/updating/update-cnf-update-prep.xml#update-cnf-update-prep)
