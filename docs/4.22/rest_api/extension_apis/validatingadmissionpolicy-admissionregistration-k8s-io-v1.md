...
| Property             | Type                                                                                       | Description                                                                                     |
|----------------------|--------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| `conditions`         | [`array (Condition)`](../objects/index.xml#io-k8s-apimachinery-pkg-apis-meta-v1-Condition) | The conditions represent the latest available observations of a policy’s current state.         |
...
| HTTP code          | Reponse body                                                                                                                     |
|--------------------|----------------------------------------------------------------------------------------------------------------------------------|
| 200 - OK           | [`ValidatingAdmissionPolicyList`](../objects/index.xml#io-k8s-api-admissionregistration-v1-ValidatingAdmissionPolicyList) schema |
| 401 - Unauthorized | Empty                                                                                                                            |
...
| Parameter | Type                                                                                                                                                                            | Description |
|-----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| `body`    | [`ValidatingAdmissionPolicy`](../extension_apis/validatingadmissionpolicy-admissionregistration-k8s-io-v1.xml#validatingadmissionpolicy-admissionregistration-k8s-io-v1) schema |             |

Body parameters

| HTTP code          | Reponse body                                                                                                                                                                    |
|--------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 200 - OK           | [`ValidatingAdmissionPolicy`](../extension_apis/validatingadmissionpolicy-admissionregistration-k8s-io-v1.xml#validatingadmissionpolicy-admissionregistration-k8s-io-v1) schema |
| 201 - Created      | [`ValidatingAdmissionPolicy`](../extension_apis/validatingadmissionpolicy-admissionregistration-k8s-io-v1.xml#validatingadmissionpolicy-admissionregistration-k8s-io-v1) schema |
| 202 - Accepted     | [`ValidatingAdmissionPolicy`](../extension_apis/validatingadmissionpolicy-admissionregistration-k8s-io-v1.xml#validatingadmissionpolicy-admissionregistration-k8s-io-v1) schema |
| 401 - Unauthorized | Empty                                                                                                                                                                           |
