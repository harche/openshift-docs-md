...
| Property   | Type                                                                             | Description                                                                                                                                                                                                                                            |
|------------|----------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `quota`    | [`ResourceQuotaSpec`](../objects/index.xml#io-k8s-api-core-v1-ResourceQuotaSpec) | quota defines the desired quota                                                                                                                                                                                                                        |
...
| `labels`      | [`LabelSelector`](../objects/index.xml#io-k8s-apimachinery-pkg-apis-meta-v1-LabelSelector) | LabelSelector is used to select projects by label.           |
