...
| `pushSecret`    | [`LocalObjectReference`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference) | pushSecret is the name of a Secret that would be used for setting up the authentication for executing the Docker push to authentication enabled Docker Registry (or Docker Hub).                                                                                                                                                             |
...
| Property         | Type                                                                                   | Description                                                                                                                                                                                                                                                                                                                                                                                           |
|------------------|----------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `configMap`      | [`LocalObjectReference`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference) | configMap is a reference to an existing configmap that you want to use in your build.                                                                                                                                                                                                                                                                                                                 |
...
| `pullSecret` | [`LocalObjectReference`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference) | pullSecret is a reference to a secret to be used to pull the image from a registry If the image is pulled from the OpenShift registry, this field does not need to be set.                                                                                                                                                                                                                                                                          |
...
| `secret`         | [`LocalObjectReference`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference) | secret is a reference to an existing secret that you want to use in your build.                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| `pullSecret`         | [`LocalObjectReference`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference) | pullSecret is the name of a Secret that would be used for setting up the authentication for pulling the container images from the private Docker registries |
...
| `secretSource` | [`LocalObjectReference`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference) | secretSource is a reference to the secret          |
...
| Property    | Type                                                                                     | Description                                                                                                                              |
|-------------|------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|
| `configMap` | [`ConfigMapVolumeSource`](../objects/index.xml#io-k8s-api-core-v1-ConfigMapVolumeSource) | configMap represents a ConfigMap that should populate this volume                                                                        |
...
| `secret`    | [`SecretVolumeSource`](../objects/index.xml#io-k8s-api-core-v1-SecretVolumeSource)       | secret represents a Secret that should populate this volume. More info: <https://kubernetes.io/docs/concepts/storage/volumes#secret>     |
