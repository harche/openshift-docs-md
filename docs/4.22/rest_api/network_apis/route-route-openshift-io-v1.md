...
| HTTP code          | Reponse body                                                                              |
|--------------------|-------------------------------------------------------------------------------------------|
| 200 - OK           | [`Status_v7`](../objects/index.xml#io-k8s-apimachinery-pkg-apis-meta-v1-Status_v7) schema |
| 401 - Unauthorized | Empty                                                                                     |
...
|--------------------|-------------------------------------------------------------------------------------------|
| 200 - OK           | [`Status_v7`](../objects/index.xml#io-k8s-apimachinery-pkg-apis-meta-v1-Status_v7) schema |
| 202 - Accepted     | [`Status_v7`](../objects/index.xml#io-k8s-apimachinery-pkg-apis-meta-v1-Status_v7) schema |
| 401 - Unauthorized | Empty                                                                                     |
