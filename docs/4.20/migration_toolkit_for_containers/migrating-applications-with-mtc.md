You can migrate your applications by using the Migration Toolkit for Containers (MTC) web console or the [command line](../migration_toolkit_for_containers/advanced-migration-options-mtc.xml#migrating-applications-cli_advanced-migration-options-mtc).
...
- [MTC snapshot copy method](../migration_toolkit_for_containers/about-mtc.xml#snapshot-copy-method_about-mtc)
