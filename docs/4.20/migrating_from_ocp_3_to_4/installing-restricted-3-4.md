...
1.  Create a [mirrored Operator catalog](../disconnected/using-olm.xml#olm-mirror-catalog_olm-restricted-networks).
...
To uninstall MTC, see [Uninstalling MTC and deleting resources](../migrating_from_ocp_3_to_4/installing-restricted-3-4.xml#migration-uninstalling-mtc-clean-up_installing-restricted-3-4).
