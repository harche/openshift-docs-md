You can migrate your applications by using the Migration Toolkit for Containers (MTC) web console or from the [command line](../migrating_from_ocp_3_to_4/advanced-migration-options-3-4.xml#migrating-applications-cli_advanced-migration-options-3-4).
...
- [Updating deprecated internal images](../migrating_from_ocp_3_to_4/troubleshooting-3-4.xml#migration-updating-deprecated-internal-images_troubleshooting-3-4)
...
- [MTC file system copy method](../migrating_from_ocp_3_to_4/about-mtc-3-4.xml#file-system-copy-method_about-mtc-3-4)

- [MTC snapshot copy method](../migrating_from_ocp_3_to_4/about-mtc-3-4.xml#snapshot-copy-method_about-mtc-3-4)
