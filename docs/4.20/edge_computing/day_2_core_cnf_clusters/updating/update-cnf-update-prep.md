...
- [Specifying the number of pods that must be up with pod disruption budgets](../../../post_installation_configuration/cluster-tasks.xml#nodes-pods-pod-disruption-configuring_post-install-pod-disruption-budgets)
