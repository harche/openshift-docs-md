...
For more information, see [Migrating from SiteConfig CRs to ClusterInstance CRs](../edge_computing/ztp-migrate-clusterinstance.xml#ztp-migrate-clusterinstance).
...
For more information, see [Configuring a local arbiter node](../installing/installing_with_agent_based_installer/installing-with-agent-based-installer.xml#installing-ocp-agent-local-arbiter-node_installing-with-agent-based-installer).
...
For more information, see [Preparing to install a two-node OpenShift cluster with fencing](../installing/installing_two_node_cluster/installing_tnf/installing-two-node-fencing.xml#installing-two-node-fencing_installing-two-node-fencing).
...
For more information, see [Supported extensions](../extensions/ce/managing-ce.xml#olmv1-supported-extensions_managing-ce).

## Hosted control planes

Because hosted control planes releases asynchronously from OpenShift Container Platform, it has its own release notes. For more information, see [Hosted control planes release notes](../hosted_control_planes/hosted-control-planes-release-notes.xml#hosted-control-planes-release-notes).
...
For more information, see [Changing CVO log level](../updating/troubleshooting_updates/gathering-data-cluster-update.xml#changing-log-data_gathering-data-cluster-update).
...
For more information, see [Configuring multiple NICs](../installing/installing_vsphere/ipi/installing-vsphere-installer-provisioned-customizations.xml#installation-vsphere-multiple-nics_installing-vsphere-installer-provisioned-customizations).

For an existing vSphere cluster, you can add multiple subnets by using [compute machine sets](../machine_management/creating_machinesets/creating-machineset-vsphere.xml#machineset-vsphere-multiple-nics_creating-machineset-vsphere).
...
For more information, see [Additional Google Cloud configuration parameters](../installing/installing_gcp/installation-config-parameters-gcp.xml#installation-configuration-parameters-additional-gcp_installation-config-parameters-gcp).
...
For more information, see [Firmware requirements for installing with virtual media](../installing/installing_bare_metal/ipi/ipi-install-prerequisites.xml#ipi-install-firmware-requirements-for-installing-with-virtual-media_ipi-install-prerequisites).
...
With this release, if you install a cluster using IBM Cloud Paks, you must allow outbound access to `icr.io` and `cp.icr.io` on port 443. This access is required for IBM Cloud Pak container images. For more information, see [Configuring your firewall](../installing/install_config/configuring-firewall.xml#configuring-firewall).
...
For more information, see [Configuring your cluster with multi-architecture compute machines](../post_installation_configuration/configuring-multi-arch-compute-machines/multi-architecture-configuration.xml#configuring-your-cluster-with-multi-architecture-compute-machines).
...
For more information, see [About the HostFirmwareComponents resource](../installing/installing_bare_metal/bare-metal-postinstallation-configuration.xml#bmo-about-the-hostfirmwarecomponents-resource_bare-metal-postinstallation-configuration).

### Required administrator acknowledgment when updating from OpenShift Container Platform 4.19 to 4.20

In OpenShift Container Platform 4.17, a previously [removed Kubernetes API](../release_notes/ocp-4-20-release-notes.xml#ocp-4-20-removed-kube-apis_release-notes) was inadvertently reintroduced. It has been removed again in OpenShift Container Platform 4.20.
...
For more information, see [Kubernetes API removals](../updating/preparing_for_updates/updating-cluster-prepare.xml#kube-api-removals_updating-cluster-prepare).
...
For more information, see [Installing a cluster on Oracle Distributed Cloud by using the Assisted Installer](../installing/installing_oci/installing-oci-assisted-installer.xml#installing-oci-assisted-installer) and [Installing a cluster on Oracle Edge Cloud by using the Assisted Installer](../installing/installing_oci_edge/installing-c3-assisted-installer.xml#installing-c3-assisted-installer).
...
Updated boot images is now supported as a Technology Preview feature for VMware vSphere clusters. This feature allows you configure your cluster to update the node boot image whenever you update your cluster. By default, the boot image in your cluster is not updated along with your cluster. For more information, see [Updated boot images](../machine_configuration/mco-update-boot-images.xml#mco-update-boot-images).
...
For more information, see [On-cluster image mode known limitations](../machine_configuration/mco-coreos-layering.xml#coreos-layering-configuring-on-limitations_mco-coreos-layering).
...
For more information, see [About route advertisements](../networking/advanced_networking/route_advertisements/about-route-advertisements.xml#about-route-advertisements).
...
Preconfigured user-defined network endpoints is available as a Technology Preview and controlled by the feature gate, `PreconfiguredUDNAddresses`. You can now explicitly control the overlay network configuration including: IP address, MAC address, and default gateway. This feature is available for Layer 2 as part of the `ClusterUserDefinedNetwork` (CUDN) custom resource (CR). Administrators can preconfigure endpoints to migrate KubeVirt virtual machines (VMs) without disruption. To enable the feature use the new fields, `reservedSubnets`, `infrastructureSubnets`, and `defaultGatewayIPs`, found in the CUDN CR. For more information about the configurations, see [Additional configuration details for user-defined networks](../networking/multiple_networks/primary_networks/about-user-defined-networks.xml#nw-udn-additional-config-details_about-user-defined-networks). Currently, static IP addresses are only supported for the `ClusterUserDefinedNetworks` CR and only for use with MTV.

### Support for migrating a configured br-ex bridge to NMState

If you used the `configure-ovs.sh` shell script to set a `br-ex` bridge during cluster installation, you can migrate the `br-ex` bridge to NMState as a postinstallation task. For more information, see [Migrating a configured br-ex bridge to NMState](../installing/installing_bare_metal/bare-metal-postinstallation-configuration.xml#migrating-br-ex-bridge-nmstate_bare-metal-postinstallation-configuration).
...
For more information, see [Configuring enhanced PTP logging](../networking/advanced_networking/ptp/configuring-ptp.xml#cnf-configuring-enhanced-log-reduction-for-linuxptp_configuring-ptp).
...
This feature is available as a Technology Preview. For more information, see [Using dual-port NICs to improve redundancy for PTP ordinary clocks](../networking/advanced_networking/ptp/about-ptp.xml#ptp-dual-ports-oc_about-ptp).
...
For more information, see [Configuration for a Bond CNI secondary network](../networking/multiple_networks/secondary_networks/creating-secondary-nwt-other-cni.xml#nw-multus-bond-cni-object_configuring-additional-network-cni).
...
For more information, see [Configuring namespaced SR-IOV resources](../networking/hardware_networks/configuring-namespaced-sriov-resources.xml#configuring-namespaced-sriov-resources).
...
For more information, see [Configuring the integration of MetalLB and FRR-K8s ](../networking/ingress_load_balancing/metallb/metallb-frr-k8s.xml#nw-metallb-frrconfiguration-crd-interface).
...
For more information, see [High availability for pod-level bonds on SR-IOV networks](../networking/hardware_networks/configure-lacp-for-sriov.xml#sriov-lacp-sriov).
...
For more information, see [Configuring PTP devices](../networking/advanced_networking/ptp/configuring-ptp.xml#configuring-ptp).
...
Support for sigstore `ClusterImagePolicy` and `ImagePolicy` objects is now generally available. The API version is now `config.openshift.io/v1`. For more information, see [Manage secure signatures with sigstore](../nodes/nodes-sigstore-using.xml#nodes-sigstore-using).
...
For more information, see [Updating a cluster by using the CLI](../updating/updating_a_cluster/updating-cluster-cli.xml#update-upgrading-cli).
...
For more information, see [ImageSet configuration parameters for oc-mirror plugin v2](../disconnected/about-installing-oc-mirror-v2.xml#oc-mirror-imageset-config-parameters-v2_about-installing-oc-mirror-v2).
...
For more information, see [Enabling AWS Security Token Service (STS) on an existing cluster](../post_installation_configuration/changing-cloud-credentials-configuration.xml#enabling-aws-sts-existing-cluster_changing-cloud-credentials-configuration).
...
For more information, see [Managing high availability (HA) for the NUMA-aware scheduler](../scalability_and_performance/cnf-numa-aware-scheduling.xml#cnf-managing-ha-nrop_numa-aware).
...
For more information, see [NUMA Resources Operator support for schedulable control-plane nodes](../scalability_and_performance/cnf-numa-aware-scheduling.xml#cnf-numa-resource-operator-support-scheduling-cp_numa-aware).
...
For more information about volume populators, see [Volume populators](../storage/container_storage_interface/persistent-storage-csi-vol-populators.xml).
...
For more information about One Zone, see [Support for One Zone](../storage/container_storage_interface/persistent-storage-csi-aws-efs.xml#one-zone-file-systems).
...
For more information about fsGroup, see [Reducing pod timeouts using fsGroup](../storage/understanding-persistent-storage.xml#using_fsGroup_overview_understanding-persistent-storage).

For more information about SELinux, see [Reducing pod timeouts using seLinuxChangePolicy](../storage/understanding-persistent-storage.xml#using_selinuxChangePolicy_overview_understanding-persistent-storage).
...
For more information, see [Reclaim policy for persistent volumes](../storage/understanding-persistent-storage.xml#reclaiming_understanding-persistent-storage).
...
For more information, see [Customizing Manila share access rules](../storage/container_storage_interface/persistent-storage-csi-manila.xml#persistent-storage-csi-manila-share-access-rules_persistent-storage-csi-manila).
...
To view the revised procedure, see [AWS EFS cross account support](../storage/container_storage_interface/persistent-storage-csi-aws-efs.xml#persistent-storage-csi-efs-cross-account_persistent-storage-csi-aws-efs).
