...
|--------------------|-----------------------------------------------------------------------------------------|
| 200 - OK           | [`PodMonitorList`](../objects/index.xml#com-coreos-monitoring-v1-PodMonitorList) schema |
...
| Parameter | Type                                                                                                                  | Description |
|-----------|-----------------------------------------------------------------------------------------------------------------------|-------------|
| `body`    | [`PodMonitor`](../monitoring_apis/podmonitor-monitoring-coreos-com-v1.xml#podmonitor-monitoring-coreos-com-v1) schema |             |

Body parameters

| HTTP code          | Reponse body                                                                                                          |
|--------------------|-----------------------------------------------------------------------------------------------------------------------|
| 200 - OK           | [`PodMonitor`](../monitoring_apis/podmonitor-monitoring-coreos-com-v1.xml#podmonitor-monitoring-coreos-com-v1) schema |
| 201 - Created      | [`PodMonitor`](../monitoring_apis/podmonitor-monitoring-coreos-com-v1.xml#podmonitor-monitoring-coreos-com-v1) schema |
| 202 - Accepted     | [`PodMonitor`](../monitoring_apis/podmonitor-monitoring-coreos-com-v1.xml#podmonitor-monitoring-coreos-com-v1) schema |
| 401 - Unauthorized | Empty                                                                                                                 |
