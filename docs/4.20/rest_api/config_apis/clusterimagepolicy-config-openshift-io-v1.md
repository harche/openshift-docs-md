...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ClusterImagePolicyList`](../objects/index.xml#io-openshift-config-v1-ClusterImagePolicyList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ClusterImagePolicy`](../config_apis/clusterimagepolicy-config-openshift-io-v1.xml#clusterimagepolicy-config-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ClusterImagePolicy`](../config_apis/clusterimagepolicy-config-openshift-io-v1.xml#clusterimagepolicy-config-openshift-io-v1) schema |
| 201 - Created | [`ClusterImagePolicy`](../config_apis/clusterimagepolicy-config-openshift-io-v1.xml#clusterimagepolicy-config-openshift-io-v1) schema |
| 202 - Accepted | [`ClusterImagePolicy`](../config_apis/clusterimagepolicy-config-openshift-io-v1.xml#clusterimagepolicy-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
