...
| `resources`             | [`ResourceRequirements`](../objects/index.xml#io-k8s-api-core-v1-ResourceRequirements) | Resources contains resource requirements to execute the deployment and any hooks.                                                                                              |
...
| `environment` | [`array (EnvVar)`](../objects/index.xml#io-k8s-api-core-v1-EnvVar) | Environment holds the environment which will be given to the container for Image. |
...
| `env`           | [`array (EnvVar)`](../objects/index.xml#io-k8s-api-core-v1-EnvVar) | Env is a set of environment variables to supply to the hook pod’s container.                                                                                                                     |
