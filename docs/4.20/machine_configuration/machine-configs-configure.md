You can use the tasks in this section to create `MachineConfig` objects that modify files, systemd unit files, and other operating system features running on OpenShift Container Platform nodes. For more ideas on working with machine configs, see content related to [updating](https://access.redhat.com/solutions/3868301) SSH authorized keys, [verifying image signatures](../security/container_security/security-container-signature.xml#security-container-signature), [enabling SCTP](https://access.redhat.com/solutions/4727321), and [configuring iSCSI initiatornames](https://access.redhat.com/solutions/5170251) for OpenShift Container Platform.
