...
To keep your hosted cluster fully operational during an update process, the control plane and the node updates must follow the [Kubernetes version skew policy](https://kubernetes.io/releases/version-skew-policy/).
