...
- See [Installation process](../../architecture/architecture-installation.xml#installation-process_architecture-installation) for more details on OpenShift Container Platform installation types and process.
