...
For more information, see [Configuring hybrid networking](../../networking/ovn_kubernetes_network_provider/configuring-hybrid-networking.xml#configuring-hybrid-ovnkubernetes).
