...
- [Creating a bastion host to access OpenShift Container Platform instances and the control plane nodes with SSH](../../../networking/networking_overview/accessing-hosts.xml#accessing-hosts)
